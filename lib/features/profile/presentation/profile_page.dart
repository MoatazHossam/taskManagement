    ...
    return AppPrimaryScrollView(
      children: [
        AppPageHeader(
          ...
          subtitle: context.l10n.demoMode,
        ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      profile.localizedDepartment(language),
          ...
          child: Column(
            ...
            children: [
              ...
              ConnectivitySelector(
                value: ref.watch(connectivityProvider),
                onChanged: (value) =>
        ...
        AppPanel(
          ...
          child: Column(
            children: [
              ListTile(
                key: const Key('access-summary'),
                leading: const Icon(Icons.shield_outlined),
                title: Text(context.l10n.accessSummary),
                trailing: const Icon(Icons.chevron_right),
                onTap: () => context.push('/access-summary'),
              ),
              ListTile(
                leading: const Icon(Icons.palette_outlined),
                title: Text(context.l10n.foundationGallery),
                trailing: const Icon(Icons.chevron_right),
                onTap: openGallery,
              ),
              ListTile(
                leading: const Icon(Icons.switch_account),
                title: Text(context.l10n.switchProfile),
                onTap: () async {
                  await ref.read(sessionProvider.notifier).logout();
                  ref.read(sessionProvider.notifier).beginProfileSelection();
                },
              ),
              ListTile(
                key: const Key('expire-session'),
                leading: const Icon(Icons.timer_off_outlined),
                title: Text(context.l10n.expireSession),
                onTap: () => ref.read(sessionProvider.notifier).expire(),
              ),
              ListTile(
...
class ConnectivitySelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = <(SimulatedConnectivityStatus, IconData, String)>[
      (
        SimulatedConnectivityStatus.online,
      ...
      (
        ...
        context.l10n.unstableConnection,
      ),
    ];
    return Column(
      children: [
